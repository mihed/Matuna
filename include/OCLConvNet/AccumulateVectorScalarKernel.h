...
#ifndef MATUNA_OCLConvNet_ACCUMULATEVECTORSCALARKERNEL_H_
#define MATUNA_OCLConvNet_ACCUMULATEVECTORSCALARKERNEL_H_
...
#endif /* MATUNA_OCLConvNet_ACCUMULATEVECTORSCALARKERNEL_H_ */
