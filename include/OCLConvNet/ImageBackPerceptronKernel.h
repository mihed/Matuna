...
#ifndef MATUNA_OCLConvNet_IMAGEBACKPERCEPTRONKERNEL_H_
#define MATUNA_OCLConvNet_IMAGEBACKPERCEPTRONKERNEL_H_
...
#endif /* MATUNA_OCLConvNet_IMAGEBACKPERCEPTRONKERNEL_H_ */
