...
#ifndef MATUNA_ConvNetOCL_ACCUMULATEVECTORSCALARKERNEL_H_
#define MATUNA_ConvNetOCL_ACCUMULATEVECTORSCALARKERNEL_H_
...
#endif /* MATUNA_ConvNetOCL_ACCUMULATEVECTORSCALARKERNEL_H_ */
