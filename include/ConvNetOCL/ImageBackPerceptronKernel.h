...
#ifndef MATUNA_ConvNetOCL_IMAGEBACKPERCEPTRONKERNEL_H_
#define MATUNA_ConvNetOCL_IMAGEBACKPERCEPTRONKERNEL_H_
...
#endif /* MATUNA_ConvNetOCL_IMAGEBACKPERCEPTRONKERNEL_H_ */
