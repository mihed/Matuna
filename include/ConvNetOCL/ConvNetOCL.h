...
#ifndef MATUNA_ConvNetOCL_ConvNetOCL_H_
#define MATUNA_ConvNetOCL_ConvNetOCL_H_
...
template<class T>
class ConvNetOCL final: public TrainableConvNet<T>
{
private:
...
public:
	ConvNetOCL(const vector<OCLDeviceInfo>& devices, unique_ptr<ConvNetConfig> config);
	virtual ~ConvNetOCL();
...
#endif /* MATUNA_ConvNetOCL_ConvNetOCL_H_ */
