...
#ifndef MATUNA_ConvNetOCL_IMAGEGRADIENTPERCEPTRONKERNEL_H_
#define MATUNA_ConvNetOCL_IMAGEGRADIENTPERCEPTRONKERNEL_H_
...
#endif /* MATUNA_ConvNetOCL_IMAGEGRADIENTPERCEPTRONKERNEL_H_ */
