...
#ifndef MATUNA_ConvNetOCL_IMAGEFORWARDPERCEPTRONKERNEL_H_
#define MATUNA_ConvNetOCL_IMAGEFORWARDPERCEPTRONKERNEL_H_
...
#endif /* MATUNA_ConvNetOCL_IMAGEFORWARDPERCEPTRONKERNEL_H_ */
