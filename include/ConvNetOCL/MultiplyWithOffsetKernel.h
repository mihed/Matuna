...
#ifndef MATUNA_ConvNetOCL_MULTIPLYWITHOFFSETKERNEL_H_
#define MATUNA_ConvNetOCL_MULTIPLYWITHOFFSETKERNEL_H_
...
#endif /* MATUNA_ConvNetOCL_MULTIPLYWITHOFFSETKERNEL_H_ */
