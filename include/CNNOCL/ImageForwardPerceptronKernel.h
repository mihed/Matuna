...
#ifndef MATUNA_CNNOCL_IMAGEFORWARDPERCEPTRONKERNEL_H_
#define MATUNA_CNNOCL_IMAGEFORWARDPERCEPTRONKERNEL_H_
...
#endif /* MATUNA_CNNOCL_IMAGEFORWARDPERCEPTRONKERNEL_H_ */
