...
#ifndef MATUNA_CNNOCL_IMAGEGRADIENTPERCEPTRONKERNEL_H_
#define MATUNA_CNNOCL_IMAGEGRADIENTPERCEPTRONKERNEL_H_
...
#endif /* MATUNA_CNNOCL_IMAGEGRADIENTPERCEPTRONKERNEL_H_ */
