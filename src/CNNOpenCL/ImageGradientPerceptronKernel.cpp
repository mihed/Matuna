...
template<class T>
void ImageGradientPerceptronKernel<T>::SetInput(OpenCLMemory* input)
{
...
template<class T>
void ImageGradientPerceptronKernel<T>::SetInputDelta(OpenCLMemory* inputDelta)
{
...
template<class T>
void ImageGradientPerceptronKernel<T>::SetGradient(OpenCLMemory* gradient)
{
