...
template<class T>
void BackConvolutionKernel<T>::SetFilters(OpenCLMemory* filters)
{
...
template<class T>
void BackConvolutionKernel<T>::SetDeltaInput(OpenCLMemory* deltaInput)
{
...
template<class T>
void BackConvolutionKernel<T>::SetOutput(OpenCLMemory* output)
{
