...
template<class T>
void ImageForwardPerceptronKernel<T>::SetInput(OpenCLMemory* input)
{
...
template<class T>
void ImageForwardPerceptronKernel<T>::SetOutput(OpenCLMemory* output)
{
...
template<class T>
void ImageForwardPerceptronKernel<T>::SetWeights(OpenCLMemory* weights)
{
...
template<class T>
void ImageForwardPerceptronKernel<T>::SetBiases(OpenCLMemory* biases)
{
