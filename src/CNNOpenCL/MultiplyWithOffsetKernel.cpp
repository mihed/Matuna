...
template<class T>
void MultiplyWithOffsetKernel<T>::SetInput(OpenCLMemory* input)
{
...
template<class T>
void MultiplyWithOffsetKernel<T>::SetInputDelta(OpenCLMemory* inputDelta)
{
...
template<class T>
void MultiplyWithOffsetKernel<T>::SetOutput(OpenCLMemory* output)
{
