...
template<class T>
void CNNOpenCL<T>::InitializeContexts(const vector<OpenCLDeviceInfo>& deviceInfos)
{

	unordered_map<cl_platform_id, tuple<OpenCLPlatformInfo, vector<OpenCLDeviceInfo>>> platformsAndDevices;
