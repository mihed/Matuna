...
template<class T>
void ImageOutputKernel<T>::SetInput(OpenCLMemory* input)
{
...
template<class T>
void ImageOutputKernel<T>::SetTarget(OpenCLMemory* target)
{
...
template<class T>
void ImageOutputKernel<T>::SetOutput(OpenCLMemory* output)
{
