...
#ifndef MATUNA_ConvNetOCL_OCLFORWARDBACKPROPLAYER_H_
#define MATUNA_ConvNetOCL_OCLFORWARDBACKPROPLAYER_H_
...
#endif /* MATUNA_ConvNetOCL_OCLFORWARDBACKPROPLAYER_H_ */
