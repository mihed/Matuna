...
namespace Matuna {
	namespace MachineLearning {
		...
		template<class T>
		ConvNetOCLFactoryVisitor<T>::ConvNetOCLFactoryVisitor(
		...
		template<class T>
		void ConvNetOCLFactoryVisitor<T>::Visit(const ConvNetConfig* const cnnConfig) {
			this->InitializeInterlock(cnnConfig);
		}

		template<class T>
		void ConvNetOCLFactoryVisitor<T>::Visit(
		...
		template class ConvNetOCLFactoryVisitor < cl_float > ;
		template class ConvNetOCLFactoryVisitor < cl_double > ;
