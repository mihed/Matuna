...
template<class T>
void BackPerceptronKernel<T>::SetWeights(OCLMemory* weights) {
	this->weights = weights;
}

template<class T>
void BackPerceptronKernel<T>::SetInput(OCLMemory* input) {
...
template<class T>
void BackPerceptronKernel<T>::SetDeltaInput(OCLMemory* deltaInput) {
...
template<class T>
void BackPerceptronKernel<T>::SetOutput(OCLMemory* output) {
