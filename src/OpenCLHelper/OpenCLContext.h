...
#ifndef MATUNA_OPENCLHELPER_OPENCLCONTEXT_H_
#define MATUNA_OPENCLHELPER_OPENCLCONTEXT_H_
...
final
{
	...
	public:
		...
		void AddProgramFromSource(OpenCLKernelProgram* kernelProgram,
				const vector<OpenCLDevice*>& affectedDevices);
		...
		void RemoveProgram(OpenCLKernelProgram* kernelProgram);
		void RemoveKernel(OpenCLKernel* kernel);
	};

	} /* namespace Helper */
	} /* namespace Matuna */

#endif /* MATUNA_OPENCLHELPER_OPENCLCONTEXT_H_ */
