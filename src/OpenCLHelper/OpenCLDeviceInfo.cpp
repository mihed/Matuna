...
OpenCLDeviceInfo::OpenCLDeviceInfo(OpenCLPlatformInfo platformInfo,
		...
		unsigned int nativeIntVectorWidth, unsigned int nativeLongVectorWidth,
		...
		size_t maxParametersSize, unsigned long long globalMemoryCacheSize,
		unsigned long long globalMemorySize,
		unsigned long long maxConstantBufferSize,
		unsigned int maxConstantArguments, unsigned long long localMemorySize,
		...
		platformInfo(platformInfo), deviceID(deviceID), globalMemoryCacheType(
				...
				deviceVersion), deviceOpenCLVersion(deviceOpenCLVersion), deviceExtensions(
				deviceExtensions) {
...
string OpenCLDeviceInfo::GetString() const {
	...
	stringStream << "CL_DEVICE_OPENCL_C_VERSION: \t" << deviceOpenCLVersion
			<< "\n";
