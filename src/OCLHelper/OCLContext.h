...
final
{
	...
	public:
		...
		void AddProgramFromSource(OCLKernelProgram* kernelProgram,
				const vector<OCLDevice*>& affectedDevices);
		void AddKernel(OCLKernel* kernel);
		...
		void RemoveProgram(OCLKernelProgram* kernelProgram);
		void RemoveKernel(OCLKernel* kernel);
	};
