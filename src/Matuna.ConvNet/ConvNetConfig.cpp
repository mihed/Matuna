...
namespace Matuna
{
	namespace MachineLearning
	{
		...
		ConvNetConfig::ConvNetConfig(const vector<LayerDataDescription>& dataDescriptions, bool lowMemoryUsage) :
			inputDataDescriptions(dataDescriptions)
		{
			this->lowMemoryUsage = lowMemoryUsage;
		}
		...
		bool ConvNetConfig::HasLowMemoryUsage() const
		{
			return lowMemoryUsage;
		}
