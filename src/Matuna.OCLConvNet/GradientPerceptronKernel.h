...
#ifndef MATUNA_OCLConvNet_GRADIENTPERCEPTRONKERNEL_H_
#define MATUNA_OCLConvNet_GRADIENTPERCEPTRONKERNEL_H_
...
#endif /* MATUNA_OCLConvNet_GRADIENTPERCEPTRONKERNEL_H_ */
