...
#ifndef MATUNA_OCLConvNet_MULTIPLYWITHOFFSETKERNEL_H_
#define MATUNA_OCLConvNet_MULTIPLYWITHOFFSETKERNEL_H_
...
#endif /* MATUNA_OCLConvNet_MULTIPLYWITHOFFSETKERNEL_H_ */
